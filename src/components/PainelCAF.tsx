...
import { Upload, FileSpreadsheet, Package, TrendingDown, AlertTriangle, CheckCircle, Clock, Search, Filter, AlertOctagon, TrendingUp, Info, Printer, Pill, BriefcaseMedical } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-sans p-6 print:p-0 print:bg-white">
      ...
      <div className="max-w-7xl mx-auto space-y-6 print:space-y-4 print:max-w-full">
        ...
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100 print:shadow-none print:border-none print:p-0 print:mb-2">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
              <Package className="text-blue-600 print:text-black" />
              Painel de Abastecimento CAF
            </h1>
            <p className="text-gray-500 text-sm mt-1 print:text-gray-700">Acompanhamento Inteligente de Compras vs. Estoque e Consumo</p>
          </div>
                  ...
                  <table className="w-full text-left border-collapse text-sm print:text-xs">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200 text-gray-600 print:bg-gray-100">
                        <th className="p-4 print:p-2 font-semibold">Previsão</th>
                        <th className="p-4 print:p-2 font-semibold">OC</th>
                        <th className="p-4 print:p-2 font-semibold min-w-[250px]">Produto</th>
                        <th className="p-4 print:p-2 font-semibold text-right">A Receber</th>
                        <th className="p-4 print:p-2 font-semibold text-right bg-blue-50/50 print:bg-blue-50">Estoque CAF</th>
                        <th className="p-4 print:p-2 font-semibold text-right bg-orange-50/50 print:bg-orange-50">Consumo Total</th>
                        <th className="p-4 print:p-2 font-semibold text-center">Cobertura</th>
                        <th className="p-4 print:p-2 font-semibold text-center">Status</th>
              ...
              <div className="overflow-x-auto print:overflow-visible">
                {filteredConsumptionData.length === 0 ? (
                  ...
                  <table className="w-full text-left border-collapse text-sm print:text-xs">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200 text-gray-600 print:bg-gray-100">
                        <th className="p-4 print:p-2 font-semibold">Código</th>
                        <th className="p-4 print:p-2 font-semibold min-w-[200px]">Produto</th>
                        ...
                        <th className="p-4 print:p-2 font-semibold text-right">Consumo Total</th>
                        <th className="p-4 print:p-2 font-semibold text-right">Média Diária</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100 print:divide-gray-200">
                      {filteredConsumptionData.map((row, idx) => {
                ...
                {filteredStockData.length === 0 ? (
                  ...
                  <table className="w-full text-left border-collapse text-sm print:text-xs">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200 text-gray-600 print:bg-gray-100">
                        <th className="p-4 print:p-2 font-semibold">Código</th>
                        <th className="p-4 print:p-2 font-semibold">Produto</th>
                        <th className="p-4 print:p-2 font-semibold">Ordem Compra</th>
                        <th className="p-4 print:p-2 font-semibold text-right">Estoque Consolidado</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100 print:divide-gray-200">
                      {filteredStockData.map((row, idx) => {
                         // Buscar a OC associada a este produto
                         const ocInfo = ordersData.find(o => o.produtoId === row.id)?.oc || '-';
                         ...
                         return (
                          <tr key={idx} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="p-4 print:p-2 font-mono text-gray-600">{ocInfo}</td>
                            <td className="p-4 print:p-2 text-right font-medium text-blue-600">{row.estoqueAtual}</td>
                          </tr>
                        );
                      })}
                    </tbody>
