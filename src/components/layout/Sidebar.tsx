...
export type TabId = 'dashboard' | 'analytics' | 'transfer' | 'vba' | 'import' | 'followup' | 'dispensary' | 'genesis' | 'previsibilidade' | 'equivalencia' | 'dispensaryProject' | 'pedido24h' | 'rastreio' | 'productivity' | 'painel_caf' | 'indicadores_caf';
