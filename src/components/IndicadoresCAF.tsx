...
import { 
  Upload, AlertOctagon, AlertTriangle, Clock, ShieldCheck, Search, CalendarDays, 
  Package, TrendingUp, Activity, Layers, ArrowDownToLine, Database
} from 'lucide-react';
      ...
      <div className="max-w-[1400px] mx-auto space-y-8">
        ...
        <header className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col md:flex-row justify-between items-center gap-4 sticky top-4 z-10">
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 leading-tight">Painel Integrado</h1>
              <p className="text-sm text-gray-500">Visão Geral: Consumo, Estoque e Validades</p>
            </div>
          </div>
